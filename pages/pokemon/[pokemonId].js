...
export default function Pokemon({ pokemon }) {
    ...
    return (
        <div className="flex flex-col items-center space-y-3 my-12">
            ...
            <div>
                <Image className='my-6' src={`https://cdn.traction.one/pokedex/pokemon/${pokemon.id}.png`} alt={pokemon.name} width={300} height={300} />
            </div>
                ...
                <div>
                    ...
                    <div className='flex space-x-2  items-center justify-center '>
                        {pokemon.types.map((item, index) => (
                            <div key={index} className="bg-gray-800 rounded py-2 px-4 text-center">
                                <FontAwesomeIcon className={"text-red-500 mr-2"} icon={faFireAlt} />
                                <small className="text-white uppercase  ">{item.type.name}</small>
                            </div>
